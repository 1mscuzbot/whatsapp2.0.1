...
Login → Home (usuários do Firebase) → Chat (chatId único)''',
  ...
  _featureItem('Não Lidas', 'Badge com contador de mensagens não lidas por chat'),
  _featureItem('Case-Insensitive', 'Emails tratados em lowercase para evitar duplicatas'),
